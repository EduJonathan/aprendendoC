...
/**
 * Este código cria uma janela com um tabuleiro de xadrez usando a biblioteca SDL2.
 * O tabuleiro se adapta ao redimensionamento da janela, mantendo as casas quadradas.
 * As casas claras são bege e as escuras são cinza escuro. Linhas de grade são desenhadas para destacar as bordas das casas.
 */
...
int main(int argc, char **argv)
{
     ...
     * Para compilar:
     *
     * gcc -o tabuleiro 2_tabuleiro.c `sdl2-config --cflags --libs` -lSDL2
     * ./tabuleiro
     */
    return 0;
}
