...
/**
 * Telas são a base de qualquer jogo. Elas representam o que o jogador vê na tela, e podem ser usadas para mostrar menus,
 * o jogo em si, telas de carregamento, etc. Neste exemplo, vamos criar uma janela simples usando a biblioteca SDL2,
 * que é amplamente utilizada para desenvolvimento de jogos em C/C++.
 */
...
int main(int argc, char **argv)
{
     ...
     *
     * gcc 1_telas.c -o minha_primeira_tela `sdl2-config --cflags --libs` -lSDL2
     * ./minha_primeira_tela
     */
