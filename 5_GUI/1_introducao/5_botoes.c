 ...
 * Botões
 * 
 * Botões são componentes interativos que permitem ao usuário executar ações específicas, através de eventos.
 * Eles são essenciais para a navegação e interação em interfaces gráficas.
 */
...
int main(int argc, char **argv)
{
    ...
    SDL_Window *win = SDL_CreateWindow("3 Botões RGB - Muda Fundo", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, W, H, SDL_WINDOW_SHOWN);
    ...
    /**
     * gcc 5_botoes.c -o botoesRGB `sdl2-config --cflags --libs` -lSDL2
     * ./rgb
     */
    return 0;
}
