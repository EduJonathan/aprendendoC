...
#include <limits.h>  // Obtém a chamada de constantes de precisão do tipo de dado inteiros
#include <float.h>   // Obtém a chamada de constantes de precisão do tipo de dado flutuante

// Datatypes(tipos de dados): São declarações que entregam uma certa quantidade de
// precisão de valores, também ocupam uma certa quantidade de memória em bytes, na
...
int main(int argc, char **argv)
{
    ...
    printf("\n=================================================================\n");
    printf("\n\t>>TAMANHO EM BYTES DOS TIPO FLOAT E DOUBLE<<\n");
    ...
    printf("\n=================================================================\n");
    printf("\n\t>>TAMANHO EM BYTES DOS TIPO CHAR<<\n");
    ...
    printf("\n=================================================================\n");
    printf("\n\t>>DESCOBRINDO LIMITE MÁXIMO DE QUANTOS CADA TIPO DE DADO POSSUE<<\n");

    printf("\n\t>>RANGE MAXIMO TIPO CHAR<<\n");
    ...
    printf("\n=================================================================\n");
    printf("\n\t>>RANGE MAXIMO DO TIPO INT E SIGNED E LONG<<\n");
    ...
    printf("\n=================================================================\n");
    printf("\n\t>>RANGE MAXIMO DO TIPO INT UNSIGNED<<\n");
    ...
    printf("\n=================================================================\n");
    printf("\n\t>>RANGE MAXIMO DO TIPO DOUBLE E FLOAT<<\n");
