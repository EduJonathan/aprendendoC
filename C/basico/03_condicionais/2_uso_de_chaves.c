...
int main(int argc, char **argv)
{
    ...
    /**
     * @note O uso de chaves vem na visão do programador, mas é recomendado o uso de {}
     * para evitar confusão no controle de fluxo. Mesmo que o uso de chaves não seja obrigatório,
