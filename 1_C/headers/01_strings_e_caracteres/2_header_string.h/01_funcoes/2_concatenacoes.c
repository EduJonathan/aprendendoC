...
/**
 * @brief Retorna o nome da função de concatenação
 *
...
/**
 * @brief Realiza a concatenação usando a função especificada e armazena o resultado na estrutura
 *
...
void concatenar_strings(Resultado_Concatenacao *res)
{
    if (res == NULL)
    {
        printf("Parâmetro inválido fornecido para concatenação de strings.\n");
        return;
    }
...
int main(int argc, char **argv)
{
    ...
    Resultado_Concatenacao testes[] = {
        ...
        {"Seguro", " com limite longo", 100, CNT_STRNCAT}, // limite maior que s2 → igual a strcat
