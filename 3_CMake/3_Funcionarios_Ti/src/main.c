...
int main(void)
{
     ...
     * > cd ~/Documentos/aprendendoC/3_CMake/3_Funcionarios_Ti/build>
     * > cmake .. ou cmake -G Ninja .. (Para gerar os arquivos do ninja)
     * > ninja ou make (Para compilar)
     * > ./c_moderno_example (Para executar)
     */
    return EXIT_SUCCESS;
}
